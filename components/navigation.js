        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex justify-center gap-2 items-center">
            ...
            <div className="flex flex-col justify-">
              <h1 className="text-2xl font-bold text-primary p-0">Stratos Edge </h1>
              <h2 className="text-primary">Training Solutions</h2>
            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navItems.map((item) => (
                <button
                  ...
                  className="text-foreground hover:text-primary px-3 py-2 text-sm font-medium transition-colors duration-200 hover:bg-green-100 cursor-pointer rounded-xl"
                >
                  {item.name}
                </button>
              ))}
          ...
          <div className="hidden md:block">
            ...
            <Button  className="bg-primary hover:bg-primary/90 text-primary-foreground hover:cursor-pointer">Get Started</Button></a>
          </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-card border-t border-border">
              {navItems.map((item) => (
                <button
                  key={item.name}
                  onClick={() => scrollToSection(item.href)}
                  className="text-card-foreground hover:text-primary block px-3 py-2 text-base font-medium w-full text-left transition-colors duration-200"
                >
                  {item.name}
                </button>
              ))}
